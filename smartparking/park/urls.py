...
from .views import  register_view, vehicle_log_list_view, index, login_view, home_view, reservation_view, reserve_slot, user, details, downtown, thankyou, airport, mall, stadium, office
...
urlpatterns = [
    ...
    path('home/downtown/details/thankyou', thankyou, name='thankyou'),
    path('vehicle-logs/', vehicle_log_list_view, name='vehicle_log_list'),
